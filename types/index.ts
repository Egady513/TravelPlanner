...
export interface CampingSpot extends Activity {
  ...
  pricePerNight?: number;
  nights?: number;
  isPrimary?: boolean;  // true = primary site, false = backup option
}
...
export interface Day {
  dayNumber: number;
  date?: Date;
  locationLabel?: string;  // user-overridable city/region label shown on day card
  lodging?: LodgingType;
...
export interface Trip {
  ...
  // Vehicle settings (for gas stop planning)
  vehicleRangeMiles?: number;   // total tank range in miles (e.g. 300)
  vehicleMpg?: number;          // for gas cost estimation
  gasPricePerGallon?: number;   // $/gal for gas cost estimation

  // Generated destination intelligence brief
