...
DEPARTURE TIME RULE: When a day has a drive with total drive hours >= ${Math.round(trip.maxDrivingHours * 0.5 * 10) / 10}h but no departure time is set (no "depart HH:MM" in the trip summary), proactively suggest a departure time: recommend leaving by 8:00-9:00 AM to arrive with daylight and flexibility. Say: "⏰ No departure time set for Day [N] — I'd suggest leaving by [TIME] to arrive at [destination] by [estimated arrival]."
